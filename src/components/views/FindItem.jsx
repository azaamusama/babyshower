...
export default function FindItem({ game, onFinish, isLast }) {
  ...
  return (
    <div className="sub-view">
      {prompt.isExample && (
        <p className="sub-view__example-note">Example scenario — host: replace with your own.</p>
      )}
      <div className="sub-view__scenario">{prompt.scenario}</div>

      <div className="sub-view__choices">
      ...
      {revealed && (
        <>
          ...
          <Button size="lg" fullWidth onClick={handleContinue}>
            {isLastPrompt ? (isLast ? "Finish" : "Next Game") : "Next Scenario"}
          </Button>
        </>
      )}
    </div>
